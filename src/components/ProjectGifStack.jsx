              ...
              {displayGifs.map((gif, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    data-gif-card
                    onMouseEnter={() => {
                      if (!animatingToTop) setHoveredIndex(idx);
                    }}
                    onMouseLeave={() => {
                      if (!animatingToTop) setHoveredIndex((h) => (h === idx ? null : h));
                    }}
                    onClick={() => {
                      if (!isActive && !animatingToTop) startBringToTopAnimation(idx);
                    }}
                  ...
                  >
                    ...
                    >
                      <img src={gif} alt={`Project gif ${idx + 1}`} style={{ display: "block", width: "100%", maxWidth: "100%", height: "auto", maxHeight: "60vh", objectFit: "contain" }} draggable={false} />
                    </motion.div>
                  </motion.div>
                );
              })}
